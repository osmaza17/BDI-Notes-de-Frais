...
const I18N = {
  fr: {
    ...
    'settings.engine': "Moteur d'analyse",
    'settings.engineClaudeCode': '✔ Claude Code détecté sur cet ordinateur',
    'settings.engineClaudeCodeOff': '✗ Claude Code introuvable sur cet ordinateur',
    'settings.engineHint': "Par défaut, l'analyse utilise Claude Code installé ici (ton abonnement, sans clé API). L'API n'est utilisée qu'en repli si tu l'actives ci-dessous.",
    'settings.apiFallback': "Utiliser l'API Anthropic en repli (si Claude Code est absent)",
    'settings.apiKeyOnlyFallback': "La clé API ne sert qu'en repli, si l'option ci-dessus est activée.",
    ...
    'aiError.claude_code_falta.title': 'Claude Code introuvable',
    'aiError.claude_code_falta.body': "L'analyse utilise Claude Code installé sur cet ordinateur, mais il est introuvable.",
    'aiError.claude_code_falta.steps': "Installe Claude Code et connecte-toi (claude login).\nOu active le repli vers l'API dans les Réglages (⚙) et renseigne une clé.\nRelance ensuite l'analyse.",
    'aiError.claude_code_auth.title': 'Claude Code non connecté',
    'aiError.claude_code_auth.body': "Claude Code est installé mais aucune session n'est connectée sur cet ordinateur.",
    'aiError.claude_code_auth.steps': "Ouvre un terminal et lance « claude login ».\nConnecte-toi avec ton compte.\nRelance ensuite l'analyse.",
    'aiError.claude_code_timeout.title': 'Délai dépassé',
    'aiError.claude_code_timeout.body': 'Claude Code a mis trop de temps à répondre.',
    'aiError.claude_code_timeout.steps': "Relance l'analyse.\nVérifie ta connexion internet.\nRéessaie si cela persiste.",
    'aiError.claude_code_salida.title': 'Réponse illisible de Claude Code',
    'aiError.claude_code_salida.body': "Claude Code a répondu, mais sa sortie n'a pas pu être interprétée.",
    'aiError.claude_code_salida.steps': "Relance l'analyse.\nConsulte le détail technique ci-dessous.\nSi cela persiste, réessaie plus tard.",
    'aiError.claude_code_error.title': 'Erreur de Claude Code',
    'aiError.claude_code_error.body': "Une erreur est survenue pendant l'analyse avec Claude Code.",
    'aiError.claude_code_error.steps': "Relance l'analyse.\nVérifie que « claude login » fonctionne dans un terminal.\nConsulte le détail technique ci-dessous.",
  ...
  es: {
    ...
    'settings.engine': 'Motor de análisis',
    'settings.engineClaudeCode': '✔ Claude Code detectado en este ordenador',
    'settings.engineClaudeCodeOff': '✗ Claude Code no encontrado en este ordenador',
    'settings.engineHint': 'Por defecto, el análisis usa Claude Code instalado aquí (tu suscripción, sin clave API). La API solo se usa como respaldo si lo activas abajo.',
    'settings.apiFallback': 'Usar la API de Anthropic como respaldo (si no hay Claude Code)',
    'settings.apiKeyOnlyFallback': 'La clave API solo se usa como respaldo, si activas la opción de arriba.',
    ...
    'aiError.claude_code_falta.title': 'No se encuentra Claude Code',
    'aiError.claude_code_falta.body': 'El análisis usa Claude Code instalado en este ordenador, pero no se encuentra.',
    'aiError.claude_code_falta.steps': 'Instala Claude Code e inicia sesión (claude login).\nO activa el respaldo a la API en Ajustes (⚙) y añade una clave.\nVuelve a lanzar el análisis.',
    'aiError.claude_code_auth.title': 'Claude Code sin sesión',
    'aiError.claude_code_auth.body': 'Claude Code está instalado pero no hay ninguna sesión iniciada en este ordenador.',
    'aiError.claude_code_auth.steps': 'Abre una terminal y ejecuta «claude login».\nInicia sesión con tu cuenta.\nVuelve a lanzar el análisis.',
    'aiError.claude_code_timeout.title': 'Tiempo agotado',
    'aiError.claude_code_timeout.body': 'Claude Code tardó demasiado en responder.',
    'aiError.claude_code_timeout.steps': 'Vuelve a lanzar el análisis.\nComprueba tu conexión a internet.\nReintenta si persiste.',
    'aiError.claude_code_salida.title': 'Respuesta ilegible de Claude Code',
    'aiError.claude_code_salida.body': 'Claude Code respondió, pero su salida no se pudo interpretar.',
    'aiError.claude_code_salida.steps': 'Vuelve a lanzar el análisis.\nMira el detalle técnico de abajo.\nSi persiste, reinténtalo más tarde.',
    'aiError.claude_code_error.title': 'Error de Claude Code',
    'aiError.claude_code_error.body': 'Ocurrió un error durante el análisis con Claude Code.',
    'aiError.claude_code_error.steps': 'Vuelve a lanzar el análisis.\nComprueba que «claude login» funciona en una terminal.\nMira el detalle técnico de abajo.',
  ...
  en: {
    ...
    'settings.engineClaudeCode': '✔ Claude Code detected on this computer',
    'settings.engineClaudeCodeOff': '✗ Claude Code not found on this computer',
    'settings.engineHint': 'By default, analysis uses Claude Code installed here (your subscription, no API key). The API is only used as a fallback if you enable it below.',
    'settings.apiFallback': 'Use the Anthropic API as a fallback (when Claude Code is absent)',
    'settings.apiKeyOnlyFallback': 'The API key is only used as a fallback, if the option above is enabled.',
    ...
    'aiError.claude_code_falta.title': 'Claude Code not found',
    'aiError.claude_code_falta.body': 'Analysis uses Claude Code installed on this computer, but it cannot be found.',
    'aiError.claude_code_falta.steps': 'Install Claude Code and log in (claude login).\nOr enable the API fallback in Settings (⚙) and add a key.\nThen run the analysis again.',
    'aiError.claude_code_auth.title': 'Claude Code not logged in',
    'aiError.claude_code_auth.body': 'Claude Code is installed but no session is logged in on this computer.',
    'aiError.claude_code_auth.steps': 'Open a terminal and run "claude login".\nLog in with your account.\nThen run the analysis again.',
    'aiError.claude_code_timeout.title': 'Timed out',
    'aiError.claude_code_timeout.body': 'Claude Code took too long to respond.',
    'aiError.claude_code_timeout.steps': 'Run the analysis again.\nCheck your internet connection.\nRetry if it persists.',
    'aiError.claude_code_salida.title': 'Unreadable response from Claude Code',
    'aiError.claude_code_salida.body': 'Claude Code replied, but its output could not be parsed.',
    'aiError.claude_code_salida.steps': 'Run the analysis again.\nSee the technical detail below.\nIf it persists, try again later.',
    'aiError.claude_code_error.title': 'Claude Code error',
    'aiError.claude_code_error.body': 'An error occurred during analysis with Claude Code.',
    'aiError.claude_code_error.steps': 'Run the analysis again.\nCheck that "claude login" works in a terminal.\nSee the technical detail below.',
    'credit': 'Developed by',
    'repo': 'Source code',
